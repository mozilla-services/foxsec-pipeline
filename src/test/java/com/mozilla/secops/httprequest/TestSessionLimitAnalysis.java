...
public class TestSessionLimitAnalysis {
  ...
  @Test
  public void sessionLimitAnalysisAlertUAVariancePresent() throws Exception {
    TestIprepdIO.deleteReputation("ip", "192.168.0.1");
    String[] eb1 =
        TestUtil.getTestInputArray(
            "/testdata/httpreq_sessionlimitanalysis1/httpreq_sessionlimitanalysis1_0.txt");
    String[] eb2 =
        TestUtil.getTestInputArray(
            "/testdata/httpreq_sessionlimitanalysis1/httpreq_sessionlimitanalysis1_2.txt");
    String[] eb3 =
  ...
  @Test
  public void sessionLimitAnalysisAlertUAVarianceMissing() throws Exception {
    TestIprepdIO.deleteReputation("ip", "192.168.0.1");
    String[] eb1 =
        TestUtil.getTestInputArray(
            "/testdata/httpreq_sessionlimitanalysis1/httpreq_sessionlimitanalysis1_1.txt");
