...
public class TestResult {
    ...
    public void testClientErrorResultFromJSON() throws Exception {
        String buf = "{\"source_address\":\"10.0.0.1\",\"window_timestamp\":\"1970-01-01T00:00:59.999Z\"," +
    ...
    public void testThresholdResultFromJSON() throws Exception {
        String buf = "{\"source_address\":\"10.0.0.2\",\"window_timestamp\":\"1970-01-01T00:00:59.999Z\"," +
