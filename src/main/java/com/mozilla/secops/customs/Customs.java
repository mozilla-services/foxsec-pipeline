...
public class Customs implements Serializable {
  ...
  public static class RlLoginFailureSourceAddress
    ...
    public PCollection<Alert> expand(PCollection<Event> col) {
      EventFilter filter = new EventFilter().setOutputWithTimestamp(emitTimestamps);
      filter.addRule(
          new EventFilterRule()
              ...
              .addPayloadFilter(
                  new EventFilterPayload(SecEvent.class)
                      .withStringMatch(
                          EventFilterPayload.StringProperty.SECEVENT_ACTION, "loginFailure")));
      filter.addKeyingSelector(
          new EventFilterRule()
              ...
              .addPayloadFilter(
                  new EventFilterPayload(SecEvent.class)
                      .withStringSelector(
                          EventFilterPayload.StringProperty.SECEVENT_SOURCEADDRESS)));
