...
/**
 * Represents a generic state interface that can be used to store and load state from
 * or to a persistent storage source
 */
public class State {
     ...
     *
     * The initialize function should be called prior to reading or writing any state using
     * the {@link State} object.
     */
