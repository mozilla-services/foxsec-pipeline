...
public class RuntimeSecrets {
    ...
    public String decrypt(String input) {
        DecryptResponse resp = kmsclient.decrypt(keyname,
            ByteString.copyFrom(Base64.getDecoder().decode(input.getBytes())));
    ...
    public static void main(String[] args) throws Exception {
        ...
        RuntimeSecrets r = new RuntimeSecrets(cmd.getOptionValue("project"),
            cmd.getOptionValue("ring"), cmd.getOptionValue("key"));
